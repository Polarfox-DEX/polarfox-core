...
describe('PolarfoxPair', () => {
  ...
  optimisticTestCases.forEach((optimisticTestCase, i) => {
    it(`optimistic:${i}`, async () => {
      ...
      await expect(pair.swap(outputAmount.add(1), 0, wallet.address, '0x', overrides)).to.be.revertedWith('Polarfox: K')
  ...
  it('swap:gas', async () => {
    ...
    expect(receipt.gasUsed).to.eq(74415)
  })
